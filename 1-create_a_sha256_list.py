...
if __name__=='__main__':   
    ...
    with open('index.html','w') as fichier:
        ...
        for file in files:
            ...
            fichier.write(f'<li>{sha} : <b>{file}</b></li>')
        fichier.write(f'<li>===========</li>')
        fichier.write(f'<li>===========</li>')
        fichier.write(f"<li><b> IN this line an example of Known malicious sha256 : 54c0cd40ea153f2b8cdc27c1b1baf96d77505807bda9979f2ba9ccb7ff0db3ed in the middle of a text line !!</></li>")            
